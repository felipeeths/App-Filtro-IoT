package com.example.eths.filtro_iot;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            ft.replace(R.id.your_placeholder, new OpcoesFragment());
            ft.commit();
            return true;
        }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.eths.filtro_iot/http/host/path")
        );
